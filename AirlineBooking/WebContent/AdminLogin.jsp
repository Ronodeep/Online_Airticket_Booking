...
<div style="display:inline; float:right; margin-top:100px; vertical-align: middle; padding:10px;" class="whitetext">
	Welcome "Username"
</div>
...
<div class="alphared whitetext">
	...
	<table cellspacing=30px>
		<tr>
			<%=message%>
			<td><label for="user ID">Admin User ID </label> <br>
			<input type="text" id="username" name="userID" placeholder="Enter your User ID"/></td>
			<td><label for="password">Admin Password </label> <br>
